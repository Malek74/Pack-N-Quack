...
export default function HotelBookingForm({ hotel, onBook, onSelect, selectedHotelDetails, handleShowDetails, loading, walletBallance }) {
    ...
    function onBookRoom(room) {
        onBook({ room, checkInDate, checkOutDate, paymentMethod, promoCode });
