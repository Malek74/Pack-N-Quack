    ...
    return (
        <div className="container rounded-lg w-[30rem] h-auto shadow-md">
            <div className="flex place-content-end">
                ...
                {/* Delete Button */}
                <Button className="w-14 absolute" onClick={props.onDelete}>
                    <Trash2 />
                </Button>

                {/* Edit Button */}
                <Button className="w-14 mx-10 absolute">
                    <EditPlace 
                        name={props.name}
            ...
            <div className="flex flex-col gap-2">
                <h1 className="flex">
                    <span className="font-semibold text-xl mr-auto text-[#71BCD6] stroke-black">
                        {props.name}
                    </span>
                </h1>
                <h4 className="text-base">{props.description}</h4>
                <h4 className="text-base"><b>Opening Hours: </b>{props.hours}</h4>
                <h4 className="text-base"><b>Location: </b>{props.location}</h4>
