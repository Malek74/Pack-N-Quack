        ...
        <div className="container rounded-lg w-[25rem] h-auto p-2 shadow-md">
            ...
            <div className="flex flex-col gap-2">
                ...
                <div className="flex flex-row justify-between gap-4">
                    <div className="flex flex-col gap-y-0">   {Array.isArray(props.discounts) && props.discounts.map((discount) => (<p key={discount}   className="text-base text-red-700 ">{discount}</p>
                    ))}</div>
